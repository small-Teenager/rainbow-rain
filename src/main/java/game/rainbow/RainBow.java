 ...
 * @author search 数字彩虹雨
 */
public class RainBow extends JDialog {
	...
	private void initProperties() throws Exception {
		...
		File file = new File(System.getProperty("user.dir") + "/src/main/resources/binary-rain.properties");// 获取配置文件
	...
	private void init() {
		...
		addKeyListener(new KeyAdapter() {// 新增一个按键侦听器
			...
			public void keyPressed(KeyEvent e) {
				if ((e.isAltDown() && e.getKeyCode() == KeyEvent.VK_F4) || (e.getKeyCode() == KeyEvent.VK_ESCAPE)) {// 按下Alt+F4或者Esc键
